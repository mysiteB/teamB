...
<script language="javascript">
   function showPopup() {
      window.open("/mysiteB/src/main/webapp/WEB-INF/views/product/productInquirybox.jsp", "a",
					...
					<div class = "row">
						...
						<div class="col-6 col-12-small">
							<ul class="actions stacked">
								<li style="text-align:right"><a onclick="showPopup()" class="button small">문의하기</a></li>
							</ul>
						</div>
